...
import uploadResponseFn from "../utils/cloudinary";
import { deletePostService, likePostService } from "../services/post.service";
...
export const getSinglePostHandler = asyncHandler(
    async (req,res,next) => {
...
export const createPostHandler = asyncHandler(
    async(req,res, next)=>{
        ...
        appAssert(content || imageFile,
            BAD_REQUEST, "Post must contain either text or image");
...
export const likePostHandler = asyncHandler(
    async(req, res,next)=>{
