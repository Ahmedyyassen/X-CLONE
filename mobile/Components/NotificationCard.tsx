...
const NotificationCard = ({onDelete,notification}:NoticationCardProps) => {
   ...
   <View className='border-b border-gray-100 bg-white'>
      <View className='flex-row p-4 '>
          <View className='relative mr-3'>
              <Image source={{uri: notification.from.profilePicture || ""}} resizeMode='cover'
              ...
              <View className='flex-1'>
                ...
                <TouchableOpacity className='ml-2 p-1' onPress={()=> onDelete(notification._id)}>
